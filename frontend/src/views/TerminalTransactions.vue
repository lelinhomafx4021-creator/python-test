...
<template>
 ...
 <div v-else class="px-5 py-8 text-center text-[13px] text-slate-500">暂无交易记录。</div>
 ...
 <div v-else class="rounded-[32px] border border-slate-200 bg-white px-6 py-14 text-center shadow-sm">
 ...
 <h4 class="mt-5 text-2xl font-semibold text-slate-950">当前没有交易记录</h4>
