    ...
    <section class="space-y-4">
      <div class="rounded-3xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
        ...
        <div class="mt-4 grid gap-2">
          <div class="rounded-2xl bg-slate-50 px-4 py-3">
            ...
            <div class="mt-1 text-[22px] font-semibold text-slate-950">
          ...
          <div class="grid grid-cols-2 gap-2">
            <div class="rounded-2xl bg-slate-50 px-4 py-3">
              ...
              <div class="mt-1 text-[16px] font-semibold text-slate-950">
          ...
          <div class="rounded-2xl bg-slate-50 px-4 py-3">
            ...
            <div class="mt-1 text-[15px] font-medium text-slate-900">
              {{ accountStatusText(paperAccount?.status) }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="rounded-3xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
        ...
        <div class="mt-4 space-y-3">
          <div>
            <div class="mb-1.5 text-[12px] font-medium text-slate-700">
              充值金额
            </div>
            <input
      ...
      <div class="rounded-3xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
        ...
        <div class="mt-4 space-y-3">
          ...
          <div class="grid grid-cols-2 gap-2">
            <button
              class="rounded-xl px-3 py-2 text-[13px] font-medium transition-all duration-150 hover:bg-rose-100/60 active:scale-[0.97]"
            ...
            <button
              class="rounded-xl px-3 py-2 text-[13px] font-medium transition-all duration-150 hover:bg-emerald-100/60 active:scale-[0.97]"
    ...
    <section class="space-y-4">
        ...
        <div v-if="pagedTransfers.length">
          ...
          >
            ...
            <div class="truncate text-slate-500">
              {{ transfer.remark || transfer.channelName }}
            </div>
            <div class="text-slate-500">
              {{ transfer.channelName }}
            </div>
            <div class="text-right text-slate-400">
              {{ transfer.paidAt || transfer.createdAt || '--' }}
            </div>
          </div>
        </div>
        <div
          v-else
          class="px-5 py-8 text-[13px] text-slate-500"
        >
          当前还没有充值流水。
        </div>
      ...
      <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        <div v-if="pagedPositions.length">
          ...
          >
            ...
            <div class="text-right text-slate-900">
              {{ formatPrice(position.latestPrice) }}
            </div>
            <div
              class="text-right"
      ...
      <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        <div v-if="pagedOrders.length">
          <div class="grid grid-cols-[90px_90px_90px_120px_1fr_140px_80px] bg-slate-50/80 px-5 py-2 text-[11px] font-medium text-slate-500">
            <div>代码</div>
            <div>方向</div>
            <div>数量</div>
            <div>价格</div>
          ...
          <div
            ...
            :key="order.id"
            class="grid grid-cols-[90px_90px_90px_120px_1fr_140px_80px] items-center border-t border-slate-100 px-5 py-3 text-[13px]"
          >
            <div class="font-medium text-slate-900">
              {{ order.symbol }}
            </div>
            ...
            <div class="text-[12px] tabular-nums text-slate-400">
