  ...
  >
    ...
    >
      <div class="flex items-start justify-between gap-3">
        ...
        <div
          v-else
          class="mx-auto flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition-colors duration-300"
        >
    ...
    <div :class="collapsed ? 'px-2 py-3' : 'px-4 py-4'">
      <button
        class="w-full border border-slate-200 bg-white text-left transition-all duration-150 active:scale-[0.98]"
    ...
    >
      <button
        ...
        :class="[
          activeView === item.key
            ...
            : 'text-slate-600 hover:bg-white/70 hover:text-slate-900 hover:shadow-[0_1px_3px_rgba(0,0,0,0.04)]',
      ...
      >
        ...
        <span
          ...
          :class="activeView === item.key ? 'bg-slate-100 text-slate-600' : 'bg-slate-200/80 text-slate-500'"
        >
          {{ item.count }}
        </span>
      </button>
    ...
    >
      ...
      <button
        class="mb-1 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] text-slate-500 transition-all duration-150 hover:bg-white/70 hover:text-slate-900 active:scale-[0.98] lg:hidden"
        @click="emit('toggle')"
      >
        <Menu class="h-4 w-4" />
        收起导航
      ...
      <button
        class="flex w-full items-center rounded-xl px-3 py-2.5 text-left text-[13px] text-slate-500 transition-all duration-150 hover:bg-white/70 hover:text-slate-900 active:scale-[0.98]"
