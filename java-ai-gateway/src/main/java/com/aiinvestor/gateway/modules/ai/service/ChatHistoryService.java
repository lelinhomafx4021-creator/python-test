...
public class ChatHistoryService {
    ...
    public void saveTurn(
            Long userId, String sessionId, String threadId, String traceId,
     ...
     * @return 聊天详情列表（按时间正序）
     */
    public List<ChatTurnVO> listTurns(Long userId, String sessionId, int limit, int offset) {
     ...
     */
    public List<ChatSessionSummaryVO> listSessions(Long userId) {
